...
urlpatterns = [
    ...
    path('add-review/<int:pk>', AddReviewsAPIView.as_view(), name='review'),
    path('add-comment/<int:pk>', AddCommentsAPIView.as_view(), name='comment'),
    path('change-review/<int:product_id>/<int:review_id>', ChangeReviewAPIView.as_view(), name='change_review'),
    path('change-comment/<int:product_id>/<int:comment_id>', ChangeCommentAPIView.as_view(), name='change_comment'),
    path('delete-review/<int:review_id>', DeleteReviewAPIView.as_view(), name='delete_review'),
    path('delete-comment/<int:comment_id>', DeleteCommentAPIView.as_view(), name='delete_comment'),
    path('give-grade/<int:product_id>', GradeProductAPIView.as_view(), name='give_grade'),
